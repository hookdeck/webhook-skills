...
- [`webhook-handler-patterns`](../webhook-handler-patterns/) - Idempotency, error handling, framework guides
- [`hookdeck-event-gateway`](../hookdeck-event-gateway/) - Production infrastructure (routing, replay, monitoring)
